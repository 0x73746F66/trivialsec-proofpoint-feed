...
def pre_process(contents: str, category: str) -> list[models.ProofPoint]:
...
def fetch(feed: models.FeedConfig) -> list[models.ProofPoint]:
...
def process(feed: models.FeedConfig, feed_items: list[models.ProofPoint]) -> list[models.FeedStateItem]:
